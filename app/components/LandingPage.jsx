                        ...
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            <div className="flex items-center">
                              ...
                              <span className="ml-2 px-2 py-0.5 text-xs bg-blue-100 text-blue-800 rounded-full">Fastest Solution</span>
                            </div>
...
function SearchComponent() {
  ...
  ------------------------------------
        ...
        {/* CTA Section */}
        <section className="py-16 bg-blue-600 text-white rounded-xl">
